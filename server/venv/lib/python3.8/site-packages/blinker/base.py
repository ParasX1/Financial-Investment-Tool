...
class Signal:
    ...
    def connect_via(self, sender: t.Any,
    ...
    def send(self,
             ...
             /,
             *,
             _async_wrapper: c.Callable[[c.Callable[...,
                                                    c.Coroutine[t.Any,
                                                                t.Any,
                                                                t.Any]]],
                                        c.Callable[...,
    ...
    async def send_async(self,
                         ...
                         /,
                         *,
                         _sync_wrapper: c.Callable[[c.Callable[...,
                                                               t.Any]],
                                                   c.Callable[...,
                                                              c.Coroutine[t.Any,
                                                                          t.Any,
    ...
    def _disconnect(self, receiver_id: c.Hashable,
                    sender_id: c.Hashable) -> None:
        if sender_id == ANY_ID:
