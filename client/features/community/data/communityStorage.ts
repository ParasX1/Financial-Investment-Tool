// File purpose: Handles Community image upload, public URL lookup, path normalization, and best-effort storage removal.
import type { SupabaseClient } from "@supabase/supabase-js";
import { COMMUNITY_IMAGE_BUCKET } from "../constants";
import { createCommunityId } from "../lib/id";
import { getUploadErrorMessage } from "../lib/communityErrors";
