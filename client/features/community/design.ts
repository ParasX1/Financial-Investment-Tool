...
export const communityUi = {
  page: "ml-[var(--community-app-rail-width)] mr-3 box-border min-h-screen overflow-x-hidden bg-transparent px-3 pb-7 pt-[86px] text-white sm:mr-0 sm:px-5 sm:pb-9 sm:pt-[94px] lg:px-6 xl:px-7",
