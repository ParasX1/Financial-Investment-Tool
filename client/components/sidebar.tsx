...
function SidebarItem({
  ...
  const content = (
    <>
      ...
      <span
        className={[
          'min-w-0 flex-1 truncate text-sm font-bold leading-tight transition-opacity duration-150',
        ...
        <div className="border-b border-[#141622] px-2 py-4">
          {showManualToggle ? (
            ...
            >
              ...
              <span
                className={[
                  'min-w-0 truncate text-sm font-bold leading-tight transition-opacity duration-150',
                  showLabel ? 'opacity-100' : 'sr-only opacity-0',
                ].join(' ')}
              >
